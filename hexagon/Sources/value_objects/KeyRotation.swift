...
/// A signed key-rotation push addressed to this device — a contact's proactive "I am
...
public struct KeyRotation: Identifiable, Equatable {
    ...
    /// The signing + key-agreement algorithm pairing `newVerifyKey`/`newEncKey` use. No
