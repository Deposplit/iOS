...
/// `mimeType`/`secretCreatedAt`, keyed by `secretId`. `ShareMetadata` rows reference this rather
...
public struct Secret: Identifiable, Equatable, Hashable, Codable {
    ...
    public init(id: UUID, label: String, mimeType: MimeType, k: Int, n: Int, secretCreatedAt: Date, state: SecretState) {
        self.id = id
        self.label = label
